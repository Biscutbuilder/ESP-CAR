...
I choose a BLDC motor and ESC kit because online I could only find a few videos on how to use a BLDC motor with microcontrollers, and they all seem to use the exact same kit with a specific BLDC motor and ESC set. This is the only thing that i could find exclusively on amazon.
